...
def register_cli(parser: argparse.ArgumentParser) -> None:
    ...
    config_show = config_subcommands.add_parser("show", help="Show effective qdrant_memory config as JSON with secrets redacted.")
    config_show.set_defaults(qdrant_subcommand="config")
    config_show.add_argument("--json", action="store_true", help="Emit raw JSON output.")
    ...
    store.add_argument("--json", action="store_true", help="Emit raw JSON output.")
    ...
    learning_store.add_argument("--json", action="store_true", help="Emit raw JSON output.")
    ...
    learning_approve.add_argument("--json", action="store_true", help="Emit raw JSON output.")
    ...
    watcher_status.add_argument("--json", action="store_true", help="Emit raw JSON output.")
    ...
    watcher_run.add_argument("--json", action="store_true", help="Emit raw JSON output.")
